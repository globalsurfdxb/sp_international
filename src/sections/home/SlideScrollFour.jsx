...
/*   const polygon1Ref = useRef(null);
  ...
  const playEntryAnimation = (index) => {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        b1.set(rightSecRef.current, { height: '100%', })
        .set(leftSecRef.current, { height: '100%', })
        .fromTo(
          videoBgRef.current,
        ...
        break;
      case 2:
        c1.set(splftimng.current, { opacity: 0, width: '0%', x: 0,  height: '100%',})
         .set(sptitle.current, { opacity: 0 })
         .set(spdscrpt.current, { opacity: 0 })
         .set(spbtn.current, { opacity: 0 })
         .set(sprghtBx.current, { opacity: 0, x: 0, height: '100%',})
      ...
      >
        ...
        >
          ...
          <div
            ...
            ref={ttbxsRef}
          >
            <div ref={leftSecRef} className="overflow-hidden relative bottom-0" >
            <div
              className="relative py-4 xl:py-[50px] xl:pl-[150px] overflow-hidden h-full"
            >
 ...
 <div
              ref={rightSecRef} className="overflow-hidden">
            <div
      ...
      >
        ...
        >
          <div className="grid grid-cols-[800px_auto] 3xl:grid-cols-[1021px_auto] h-full bg-transparent ">
            <div className="relative" ref={splftimng}>
            <div className="lftblc absolute w-full h-full right-0 ">
            ...
            <div  ref={sprghtBx} className="absolute bottom-0 right-0">
            <div className=" flex flex-col h-full px-[70px] 3xl:px-[100px] pb-[120px] 3xl:pb-[150px] pt-[120px] 3xl:pt-[150px] overflow-hidden relative" >
...
export default SlideScrollFour;
