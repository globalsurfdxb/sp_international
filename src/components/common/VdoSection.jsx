...
import { engineeringData } from "../EngineeringConstruction/data";
        ...
        <div>
          <div>
            <div className="max-w-[795px] ml-auto mb-5 xl:mb-[70px]">
              <h2 className="text-60 font-light leading-[1.166666666666667] mb-6 xl:mb-10">{engineeringData.mainSection.title}</h2>
              {
                engineeringData.mainSection.desc.map((item)=>(
          ...
          <div>
            <VideoPlayer src={engineeringData.mainSection.vdo} poster={engineeringData.mainSection.vdoPoster} />
          </div>
