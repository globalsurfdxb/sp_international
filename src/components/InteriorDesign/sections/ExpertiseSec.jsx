              ...
              data.items.map((item, index) => (
                <div className="relative overflow-hidden" >
                  ...
                  <div className="border-b lg:border-l lg:border-b-0 border-cmnbdr p-4 xl:p-10">
                    ...
                    <motion.p variants={moveDown(0.2*index)} initial="hidden" whileInView="show" viewport={{ amount: 0.6, once: true }} className="text-paragraph text-19 leading-[1.526315789473684] font-light">{item.desc}</motion.p>
                  </div>
                </div>
              ))}
          </div>
