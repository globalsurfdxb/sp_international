...
const ExpertiseSec = () => {
  ...
  return (
    <section className="relative pt-text90 pb25 bg-primary text-white overflow-hidden" ref={sectionRef}>
      <div className="absolute bottom-[-358px] lg:bottom-[-150px] 3xl:bottom-0 right-0 w-[200px] lg:w-[400px] 3xl:w-[573px] h-[803px]"><motion.img style={{y:shapeY}} src={assets.mainShape} alt="" /></div>
