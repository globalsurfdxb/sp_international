...
const Banner = () => {
  ...
  return (
    <section ref={sectionRef} className="relative w-full h-[280px] lg:h-[560px] bg-secondary/20 overflow-hidden">
    ...
    <div className=" relative z-2 h-full " ref={targetRef}>
      ...
      <img  src="../assets/images/svg/sv-02.svg" className="w-[432px] h-[607px] object-cover object-center" alt="" />
    </motion.div>
  </section>
  );
};
