      ...
      <div className="container ">
        ...
        <div className="grid md:grid-cols-2 2xl:grid-cols-3 3xl:grid-cols-[506px_1fr_1fr] md:gap-y-8 3xl:gap-y-17">
          {regionalData.offices.map((office, index) => (
            <motion.div variants={zoomIn(0.4 + 0.1*index)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} key={index} className="odd:md:border-r-0 odd:2xl:border-r-1 first:pt-0 first:md:pt-8 px-0 md:px-5 p-5 py-8 3xl:px-15 3xl:pb-15 md:border-r md:border-t border-b border-[#CCCCCC] no-border-right no-pl0 ">
