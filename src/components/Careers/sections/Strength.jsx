  ...
  return (
    <section className="py-8 md:py-15 xl:py-20 2xl:py-25">
      <div className="container flex flex-col md:flex-row items-start 2xl:gap-[190px]">
        {/* Left Button */}
        <div className="mb-10 md:mb-0 md:mt-[10px] flex justify-center md:justify-start">
          <div className="relative inline-block">
            ...
            <span
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 
                 text-black text-16 leading-[1.75] font-light
                 hover:opacity-[0.8] transition-all duration-300 ease-in-out 
            ...
            <span
              className="absolute inset-0 rounded-full bg-[#0055A5] opacity-0 
