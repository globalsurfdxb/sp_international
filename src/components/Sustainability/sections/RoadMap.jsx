...
const RoadMap = ({data}) => {
  ...
  return (
    <section className="relative pt-text90 pb25  overflow-hidden" ref={sectionRef}>
      ...
      <div className="absolute bottom-0 right-0 2xl:-right-30 3xl:right-0 w-[200px] md:w-[359px] h-[340px] md:h-[625px] 3xl:w-[519px] 3xl:h-[725px]"><motion.img style={{y:shapeY}} src={assets.mainShape3} alt="" /></div>
