  ...
  return (
    ...
    > 
      ...
      <div className="flex overflow-hidden gap-10 lg:gap-[217px]   ">
        ...
        <div
          className={`hidden lg:flex min-w-[35px] min-h-[35px] lg:w-[50px] lg:h-[50px] rounded-full border border-black/20 justify-center items-center transition-transform duration-500 ${
            isHovered ? "rotate-180" : ""
          }`}
        >
          <img
