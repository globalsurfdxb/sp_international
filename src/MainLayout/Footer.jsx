...
const Footer = () => {
  return (
    <div className="bg-[#191919] pt-12 lg:pt-20 2xl:pt-[153px] text-white">
      <div className="container">
        <div className="border-b border-white/30 grid gap-6 lg:gap-0 grid-cols-1 lg:grid-cols-[350px_auto] xl:grid-cols-[549px_auto]">
          ...
          <div className="lg:pl-20 xl:pl-20 2xl:pl-[107px] pb-6 md:pb-9 lg:pb-15 xl:pb-20">
            ...
            <motion.div variants={moveUp(0.3)} initial="hidden" animate="show" className="flex flex-wrap items-center gap-[22px] mb-[35px]">
        ...
        <div className="grid gap-y-4 md:gap-y-8 lg:gap-3 md:grid-cols-2 lg:grid-cols-5 2xl:grid-cols-5 pt-5 md:pt-8 lg:pt-12 xl:pt-[53px] pb-5 md:pb-8 lg:pb-12 xl:pb-[45px]">
          <motion.div variants={moveUp(0.2)} initial="hidden" animate="show">
            ...
            <ul>
              <li className="opacity-70 hover:opacity-100 transition-all duration-200 text-[16px] xl:text-19 leading-[1.578947368421053] font-light"><a href="#">Overview</a></li>
      ...
      <motion.div variants={moveUp(0.7)} initial="hidden" animate="show" className="py-1 lg:pt-[20px] lg:pb-[28px] border-t border-white/30">
        <div className="container">
