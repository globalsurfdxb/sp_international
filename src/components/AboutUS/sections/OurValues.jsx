...
const OurValues = () => {
  ...
  return (
    ...
    <section className="pt-text30 pb30 relative overflow-hidden" ref={sectionRef}>
      <motion.img style={{y:shapeY}} ref={sectionRef} variants={moveLeft(1)} initial="hidden" whileInView="show" viewport={{amount: 0.2, once: true}} src="/assets/images/svg/sv-02.svg" alt="" width={"432px"} height={"607px"} className="absolute bottom-0 right-0 z-[-1] w-[152px] h-full md:w-[232px] md:h-full lg:w-[432px] lg:h-[607px]" />
