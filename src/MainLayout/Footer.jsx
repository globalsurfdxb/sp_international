...
const Footer = () => {
  return (
    <div className="bg-[#191919] pt-[153px] text-white">
      <div className="container">
        <div className="border-b border-white/30 grid grid-cols-1 xl:grid-cols-[549px_auto]">
          ...
          <div className="xl:pl-[107px] pb-20">
            ...
            <motion.div variants={moveUp(0.3)} initial="hidden" animate="show" className="flex flex-wrap items-center gap-[22px] mb-[22px]">
      ...
      <motion.div variants={moveUp(0.7)} initial="hidden" animate="show" className="pt-[20px] pb-[28px] border-t border-white/30">
        <div className="container">
