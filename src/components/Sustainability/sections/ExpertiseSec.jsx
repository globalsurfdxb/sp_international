...
const ExpertiseSec = () => {
  ...
  const { expertiseData } = sustainabilityData;
              ...
              <div className="flex flex-col gap-8 lg:gap-[80px] justify-between 3xl:mt-12">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-[66px] h-[66px] bg-secondary/30 rounded-full flex items-center justify-center">
                    ...
                    <div>
                      <h3 className="text-29 leading-[1.724137931034483] text-black font-light">{expertiseData?.items?.[activeIndex]?.title}</h3>  
                    </div>
                  </div>
                  <div className="mt-4 xl:mt-5 border-t border-cmnbdr pt-4 xl:pt-[28px]">
                      {activelist.map((desc, i) => (
                        <p key={i} className='text-19 leading-[1.526315789473684] text-paragraph font-light max-w-lg'>{desc}</p>
                      ))}
                  </div>
                </div>
              </div>
