...
const Trusted = () => {
  ...
  return (
    <section className="py-10 xl:py-15 2xl:py-22 3xl:py-[92px] relative overflow-hidden" ref={sectionRef}>
      <motion.img style={{y:shapeY}} variants={moveLeft(1)} initial="hidden" whileInView="show" viewport={{amount: 0.2, once: true}} src="/assets/images/svg/sv-02.svg" alt="" width={"432px"} height={"607px"} className="w-[152px] h-[200px] sm:w-[232px] sm:h-[407px] md:w-[332px] md:h-[507px] lg:w-[432px] lg:h-[607px] absolute -bottom-15 md:bottom-0 right-0 z-[-1]" />
