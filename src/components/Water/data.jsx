...
export const wtrData = {
 mainSection:{
    title:"Delivering Reliable and Sustainable Water Solutions",
 ...
 expertiseData:{
     ...
     items:[
      {
          ...
          desc: [ "Design, construction, testing, and commissioning of water storage reservoirs.","Ancillary works: disinfection and chemical buildings, pump stations, tanker filling stations, utility culverts, access roads, and attenuation ponds."],
  ...
  DivisionEx:{
   title:"Division Expertise & Strengths",
    items:[
        {
            image:"./assets/images/water/des1.jpg",
            title:"Specialized Execution Capabilities",
            desc:"Proven track record in delivering large-scale water transmission projects using micro tunneling and open-cut techniques in high-density urban and VIP zones.",
          },
        {
            image:"./assets/images/water/des2.jpg",
            title:"Technical Excellence",
            desc:"Expertise in SCADA integration, automated valve systems, and hydraulic control systems for reliable operations.",
          },
        {
            image:"./assets/images/water/des3.jpg",
            title:"Complex Stakeholder Management",
            desc:"Extensive experience coordinating with multiple government authorities and clients for timely approvals and smooth execution.",
          },
        {
            image:"./assets/images/water/des4.jpg",
            title:"Safety & Quality Assurance",
            desc:"Commitment to QHSE compliance and international standards for safe, on-time, and high-quality project delivery.",
          },
