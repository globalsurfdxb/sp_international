...
const SecondSection = ({data}) => {
  ...
  return (
    <section className="relative pt-text90 pb25 bg-primary text-white overflow-hidden" ref={sectionRef}>
      ...
      <div className="absolute bottom-[-52px] right-0 "><motion.img style={{y:shapeY}} src={assets.mainShape} className=' object-contain w-[325px] 3xl:w-[425px] h-[594px] ' alt="" /></div>
      <div className="container relative z-10">
        {/* Header */}
        <div className="mb-4 xl:mb-50px 3xl:mb-17">
              ...
              data.items.map((item,index)=>(
                <div>
                  <motion.div variants={moveUp(0.2*index)} initial="hidden" whileInView="show" viewport={{ amount: 0.6, once: true }} className='border-b border-white/30 pb-30px'>
                    <img src={item.icon} alt="" width={65} height={65} className='h-10 w-auto xl:h-[50px] 3xl:h-[65px] object-contain' />
                  </motion.div>
