      ...
      <div className="container ">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[658px_auto]  gap-5 2xl:gap-15 3xl:gap-23 items-center">
          <div className="relative overflow-hidden" ref={imageContainerRefTwo}>
            <motion.img style={{y:imageY}} variants={moveUp(1.6)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} src={coreValueData.image} width={658} height={545} alt="" className="w-full xs:w-[70%] md:w-full h-[200px] xs:h-[250px] md:h-[300px] lg:h-[400px] 2xl-h-[545px] object-cover" />
          </div>
