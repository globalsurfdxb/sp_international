  ...
  return (
    <section className="bg-primary text-white w-full flex flex-col md:flex-row xl:h-[600px] 2xl:h-[656px] overflow-hidden py-10 md:py-0">
      ...
      <div
        ...
        style={{
          paddingLeft: isWideScreen ? `${leftOffset}px` : undefined,
        }}
      >
        {/* Left Section */}
        <div className="relative w-full md:w-1/2 flex flex-col justify-center pb-6  md:py-0">
          ...
          <img
            ...
            className="
              ...
              opacity-90
              w-[220px] sm:w-[300px] md:w-[360px] lg:w-[420px] xl:w-[425px]
              h-auto
          ...
          <div className={`relative z-10 ${!isWideScreen ? "container" : ""}`}>
            <h2 className="text-60 font-light leading-[1.166666666666667] max-w-[390px] mb-[24px] md:mb-[30px]">
              {title}
            </h2>
            <p className="text-19 font-light leading-[1.473684210526316] max-w-[550px]">
              {description}
            </p>
          </div>
        </div>
        ...
        {/* Right Section */}
        <div
          className={`w-full md:w-1/2 h-[260px] sm:h-[340px] md:h-[420px] lg:h-auto px-[15px] md:px-0`}
        >
          <img
            src={rightImage}
            alt="people"
