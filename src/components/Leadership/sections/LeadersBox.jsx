...
const LeaderBox = ({ data }) => {
  ...
  const isTablet = useMediaQuery({ minWidth: 768, maxWidth: 1280 }); // 768 - 1023
  const isLaptop = useMediaQuery({ minWidth: 1280, maxWidth: 1600 }); // 1280 - 1550
  const isDesktop = useMediaQuery({ minWidth: 1550, maxWidth: 1920 }); // 1550 - 1920
  const imageOffset = isMobile ? [-10, 10] : isTablet ? [-20, 20] : isLaptop ? [-50, 50] : isDesktop ? [-100, 100] : [-200, 200];
    ...
    <section className="relative " ref={sectionRef}>
      ...
      <div className="container">
       <div className="border-b border-cmnbdr relative overflow-hidden mb-5 xl:mb-20 2xl:mb-25">
            ...
            <div className="pt-5 xl:pt-8 2xl:pt-12 3xl:pt-[68.5px] lg:pl-8 xl:pl-15 2xl:pl-17 3xl:pl-[97px]">
              ...
              <div
                ...
                onWheel={(e) => {
                  ...
                  // Allow scroll to pass through if at top and scrolling up, or at bottom and scrolling down
                  if ((isAtTop && e.deltaY < 0) || (isAtBottom && e.deltaY > 0)) {
                    return; // Let the event bubble to parent
                  }

                  // Otherwise, stop propagation to keep scroll within this div
                  e.stopPropagation();
                }}
                style={{
          ...
          <div className="xs:mt-10 md:mt-30 lg:mt-10 2xl:mt-17 3xl:mt-[135px] grid items-center grid-cols-1 lg:grid-cols-2 
        3xl:grid-cols-[793px_auto] gap-6 md:gap-10 xl:gap-15 2xl:gap-17 3xl:gap-[88px] pb-10 xl:pb-25 3xl:pb-[135px]">
