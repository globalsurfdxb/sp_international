...
const FocusArea = () => {
  ...
  const itemCount = focusData.areas.length;
          ...
          <div className="flex gap-6 xl:gap-[80px] justify-end relative z-[2]">
            ...
            >
              {focusData.areas.map((area, i) => (
                <div key={i} className="pb-6 xl:pb-[63px] last:pb-6 last:xl:pb-[63px] flex items-start" style={{ minHeight: '262px' }}>
                  <img src={area.icon} alt='' className="pt-2" />
                </div>
              ))}
            </div>
                  ...
                  <div key={i} className="flex gap-3 pb-6 xl:pb-[63px] last:pb-6 last:xl:pb-[63px]">
                    <div className='flex flex-col lg:flex-row gap-6 lg:gap-12 2xl:gap-[181px] justify-between w-full sdsdsd'>
                      ...
                      <div className='relative overflow-hidden mb-3 xs:mb-0' >
                        <motion.img variants={moveUp(0.2 * i)} initial="hidden" whileInView="show" viewport={{ amount: 0.2, once: true }} src={area.image} alt="" className='w-full  object-cover h-[200px] lg:min-h-[262px]  min-w-[258px] lg:min-w-[358px] xl:min-w-[478px]' />
                      </div>
                    </div>
                  </div>
                ))}
