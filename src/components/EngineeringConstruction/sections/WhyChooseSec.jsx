...
const WhyChooseSec = ({data}) => {
  ...
  return ( 
    <section className="pt-text30 pb30 relative overflow-hidden">
      <div className="absolute bottom-0 left-[-100px] xl:left-0 w-fit h-fit pb-20 lg:pb-25 xl:pb-30" ref={imageParRef}>
          <motion.img style={{y:imageY}} src={assets.mainShape2} alt="" className="object-contain w-[325px] h-[494px] xl:w-[425px] xl:h-[594px]" />
        </div>
      <div className="container relative">
        <div className="max-w-[800px] 2xl:max-w-[900px] 3xl:max-w-[1207px] ml-auto">
          <div className="border-b border-cmnbdr pb-5 xl:pb-50px">
              <H2Title titleText="Why Choose Us" titleColor="black" marginClass=" mb-4  xl:mb-5" />
